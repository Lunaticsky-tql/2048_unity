...
public class UGUIHotKey
{
    ...
    [MenuItem ("GameObject/UGUI/Image #&a", false, 6)] //参数意义请查阅API文档，上文有链接，函数中的几个其他接口的调用的含义也有介绍
    ...
    [MenuItem ("GameObject/UGUI/Text #&w", false, 6)]
    ...
    //添加按钮
    [MenuItem ("GameObject/UGUI/Button #&d", false, 6)]
